...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "And the leaders who actually fix these systems tend to share one trait, which is the [unpopular opinion that might save your career](unpopular-opinion-that-might-save-your-career): they stay technical. You cannot redesign a system you no longer understand.",
  ...
  },
  {
    ...
    body: [
      ...
      "Doing any of this credibly as a leader assumes you are still close enough to the tools to use them, which is the whole point of the [unpopular opinion that might save your career](unpopular-opinion-that-might-save-your-career). Testing AI and LLMs is a different beast and nobody is going to learn it for you.",
  ...
  },
  {
    ...
    body: [
      ...
      "This was not just a tech win, it was a trust win. It pairs naturally with [letting AI write the tests humans never would](ai-writes-the-tests-humans-wont): one side generates coverage broadly, the other quietly evicts the unstable tests before they erode confidence.",
      "Worth noting: the only reason this shipped is that I stayed hands-on. That is the whole argument behind the [unpopular opinion that might save your career](unpopular-opinion-that-might-save-your-career) — leaders who lose the tools lose the ability to build things like this. The full write up, with the feature set and the CI wiring, lives on my main site.",
    ],
  },
  {
