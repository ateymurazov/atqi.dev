...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "INSIGHTS / 2026 — Aleksandr Teymurazov" },
      { name: "description", content: "Engineering insights by Aleksandr Teymurazov on quality, AI driven delivery, and scaling software teams. Companion journal to alextnow.com." },
      { property: "og:title", content: "INSIGHTS / 2026 — Aleksandr Teymurazov" },
      { property: "og:description", content: "Engineering insights by Aleksandr Teymurazov on quality, AI driven delivery, and scaling software teams. Companion journal to alextnow.com." },
